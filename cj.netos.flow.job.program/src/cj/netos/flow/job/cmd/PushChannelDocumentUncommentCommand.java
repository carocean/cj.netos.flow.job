...
@CjService(name = "/channel/document/uncomment.mq#pushChannelDocumentUncomment")
public class PushChannelDocumentUncommentCommand extends DefaultBroadcast implements IConsumerCommand {
    ...
    public void command(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws RabbitMQException, RetryCommandException, IOException {
        ...
        JPushFrame frame = new JPushFrame("uncommentDocument /netflow/channel gbera/1.0", bb);
