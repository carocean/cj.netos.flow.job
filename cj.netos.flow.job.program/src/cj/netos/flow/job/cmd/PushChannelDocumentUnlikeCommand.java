...
@CjService(name = "/channel/document/unlike.mq#pushChannelDocumentUnlike")
public class PushChannelDocumentUnlikeCommand extends DefaultBroadcast implements IConsumerCommand {
    ...
    public void command(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws RabbitMQException, RetryCommandException, IOException {
        ...
        JPushFrame frame = new JPushFrame("unlikeDocument /netflow/channel gbera/1.0", bb);
        frame.parameter("unliker",unliker);
        ...
        while (true) {
            List<String> outputPersons = this.channel.findOutputPersons(unliker, channel, limit, skip);
